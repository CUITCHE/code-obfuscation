 ...
 */
@interface CO_CONFUSION_CLASS JSONModel : NSObject <AbstractJSONModelProtocol, NSSecureCoding>
 ...
 */
CO_CONFUSION_METHOD- (NSString *)toJSONString;

/**
 * Export the whole object to a JSON data text string
 * @return JSON text data describing the data model
 */
CO_CONFUSION_METHOD- (NSData *)toJSONData;
 ...
 * @return JSON text describing the data model
 */
CO_CONFUSION_METHOD- (NSString *)toJSONStringWithKeys:(NSArray *)propertyNames;
 ...
 * @return JSON text data describing the data model
 */
CO_CONFUSION_METHOD- (NSData *)toJSONDataWithKeys:(NSArray *)propertyNames;
 ...
 */
CO_CONFUSION_METHOD+ (NSMutableArray *)arrayOfModelsFromDictionaries:(NSArray *)array error:(NSError **)err;
CO_CONFUSION_METHOD+ (NSMutableArray *)arrayOfModelsFromData:(NSData *)data error:(NSError **)err;
CO_CONFUSION_METHOD+ (NSMutableArray *)arrayOfModelsFromString:(NSString *)string error:(NSError **)err;
CO_CONFUSION_METHOD+ (NSMutableDictionary *)dictionaryOfModelsFromDictionary:(NSDictionary *)dictionary error:(NSError **)err;
CO_CONFUSION_METHOD+ (NSMutableDictionary *)dictionaryOfModelsFromData:(NSData *)data error:(NSError **)err;
CO_CONFUSION_METHOD+ (NSMutableDictionary *)dictionaryOfModelsFromString:(NSString *)string error:(NSError **)err;
 ...
 */
CO_CONFUSION_METHOD+ (NSMutableArray *)arrayOfDictionariesFromModels:(NSArray *)array;
CO_CONFUSION_METHOD+ (NSMutableDictionary *)dictionaryOfDictionariesFromModels:(NSDictionary *)dictionary;
 ...
 */
CO_CONFUSION_METHOD- (BOOL)validate:(NSError **)error;
 ...
 */
CO_CONFUSION_METHOD+ (JSONKeyMapper *)keyMapper;
 ...
 */
CO_CONFUSION_METHOD+ (BOOL)propertyIsOptional:(NSString *)propertyName;
 ...
 */
CO_CONFUSION_METHOD+ (BOOL)propertyIsIgnored:(NSString *)propertyName;
 ...
 * }
 */
CO_CONFUSION_METHOD+ (Class)classForCollectionProperty:(NSString *)propertyName NS_SWIFT_NAME(classForCollectionProperty(propertyName:));
 ...
 */
CO_CONFUSION_METHOD- (BOOL)mergeFromDictionary:(NSDictionary *)dict useKeyMapping:(BOOL)useKeyMapping error:(NSError **)error;
