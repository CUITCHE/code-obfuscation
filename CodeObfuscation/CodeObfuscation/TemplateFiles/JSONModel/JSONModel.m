...
CO_CONFUSION_METHOD-(void)__setup__
{
...
CO_CONFUSION_METHOD-(JSONKeyMapper*)__keyMapper
{
    //get the model key mapper
    return objc_getAssociatedObject(self.class, &kMapperObjectKey);
}

CO_CONFUSION_METHOD-(BOOL)__doesDictionary:(NSDictionary*)dict matchModelWithKeyMapper:(JSONKeyMapper*)keyMapper error:(NSError**)err
{
...
CO_CONFUSION_METHOD-(NSString*)__mapString:(NSString*)string withKeyMapper:(JSONKeyMapper*)keyMapper
{
    if (keyMapper) {
        //custom mapper
...
CO_CONFUSION_METHOD-(BOOL)__importDictionary:(NSDictionary*)dict withKeyMapper:(JSONKeyMapper*)keyMapper validation:(BOOL)validation error:(NSError**)err
{
...
CO_CONFUSION_METHOD-(BOOL)__isJSONModelSubClass:(Class)class
{
...
CO_CONFUSION_METHOD-(NSMutableSet*)__requiredPropertyNames
{
...
CO_CONFUSION_METHOD-(NSArray*)__properties__
{
...
CO_CONFUSION_METHOD-(void)__inspectProperties
{
...
CO_CONFUSION_METHOD-(id)__transform:(id)value forProperty:(JSONModelClassProperty*)property error:(NSError**)err
{
...
CO_CONFUSION_METHOD-(id)__reverseTransform:(id)value forProperty:(JSONModelClassProperty*)property
{
    Class protocolClass = NSClassFromString(property.protocol);
...
CO_CONFUSION_METHOD- (BOOL)__customSetValue:(id <NSObject>)value forProperty:(JSONModelClassProperty *)property
{
...
CO_CONFUSION_METHOD- (BOOL)__customGetValue:(id *)value forProperty:(JSONModelClassProperty *)property
{
...
CO_CONFUSION_METHOD-(void)__createDictionariesForKeyPath:(NSString*)keyPath inDictionary:(NSMutableDictionary**)dict
{
